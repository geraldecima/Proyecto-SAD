...
<body  background="images/foto1.jpg">
		...
		<div class="container-login200" >
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
					...
					<div class="wrap-input100 validate-input" data-validate="CUIL">
						...
						<input class="input100" type="text" id="cuil" name="cuil" placeholder="Ingrese su CUIL" required="">
  ...
  <strong>¡Atencion!</strong> Datos incorrectos , verifique e intente nuevamente.
</div>
